(function()
{
    ...
    class subColor
    {
	    ...
	    deps.logger.debug('subColor plugin loaded!');
            ...
            this.listeners =
            {
                ...
                mcuStatus: new Listener( self.globalBus, 'mcu.status', false, function( data )
                {
                    ...
                    if( 'subColor' in data )
                    {
                        ...
                        var message = data.subColor;
                        // Re-emit the message on the cockpit messaging bus (talks to the browser)
                        self.cockpitBus.emit( 'plugin.subColor.value', message );
                    }
                })
            }
        }
