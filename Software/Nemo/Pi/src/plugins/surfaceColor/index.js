(function()
{
    ...
    class surfaceColor
    {
	    ...
	    deps.logger.debug('surfaceColor plugin loaded!');
            ...
            this.listeners =
            {
                ...
                mcuStatus: new Listener( self.globalBus, 'mcu.status', false, function( data )
                {
                    ...
                    if( 'surfaceColor' in data )
                    {
                        ...
                        var message = data.surfaceColor;
                        // Re-emit the message on the cockpit messaging bus (talks to the browser)
                        self.cockpitBus.emit( 'plugin.surfaceColor.value', message );
                    }
                })
            }
        }
        ...
        start()
        {
          ...
          console.log("surfaceColor started!!");
        }
    ...
    {
        return new surfaceColor(name, deps);
    };
}());
